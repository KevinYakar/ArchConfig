			...
			return class HideChannels extends Plugin {
				...
				onStart() {
					PluginUtilities.addStyle(config.info.name + 'CSS',
						...
						.sidebar-1tnWFu .container-3baos1 { transition: 300ms ease all; }
						...
						.sidebar-1tnWFu + .chat-3bRxxu .messagesWrapper-1sRNjr + .form-2fGMdU { margin-left: 0; transition: 300ms ease margin-left; }
						.sidebar-1tnWFu.hideElement + .chat-3bRxxu .messagesWrapper-1sRNjr + .form-2fGMdU { margin-left: 240px; }
						.sidebar-1tnWFu, .hideElement { transition: width 300ms ease; }
